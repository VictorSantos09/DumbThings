...
{
    public class JokeService : BaseService<JokeEntity>, IRequest<JokeEntity>
    {
        ...
        {
           var result = _service.InitializeAndLoad("https://official-joke-api.appspot.com/random_joke", new JokeEntity(null,null));
